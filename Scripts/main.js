...
function graphCondamnationsPenales(canton, annee) {

    const data = cpData.filter(d => d.canton === canton && d.Year === annee);
    // peut etre mettre year au lieu d'annee
